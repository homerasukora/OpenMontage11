...
export type Shot = {at: string; lead: number; type: 'band' | 'hero' | 'void'; src?: string};
 ...
 */
export const Band: React.FC<{src: string; dur: number; seed?: number}> = ({
  src, dur, seed = 0,
}) => {
...
/** A void shot is not flat black — the archive wall keeps the ground alive. */
