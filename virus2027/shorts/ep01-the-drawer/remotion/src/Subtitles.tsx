...
import {C, EASE_SIGNAL, F, FPS, SAFE, W} from './theme';
...
export const Subtitles: React.FC<{chunks: Chunk[]; baseline?: number}> = ({
  ...
  // longer chunks step down a size so the block never wraps past two lines
  const chars = chunk.text.length;
  const size = chars > 22 ? 66 : chars > 16 ? 74 : 82;
